...
$objLibro->create($_POST['txtIdLibro'], $_POST['txtTituloLibro'], $_POST['txtAutorLibro'], $_POST['txtCantidadLibro'], $_POST['txtCategoriaLibro']);
...
<div class="container p-4">
    ...
    <div class="card card-body bg-dark">
        ...
        <form method="post" action="new_libro.php" class="row row-cols-5">
            <div class="mb-3 col">
                <label class="col-sm-2 col-form-label">ID</label>
                <input type="text" name="txtIdLibro" class="form-control" autofocus>
            </div>
            <div class="mb-3 col">
